...
function optionsframework_options() {						
	...
	$del_trans_link_html .= '"><span class="glyphicon glyphicon-floppy-remove"></span> x Delete Transients</a><div class="explain">Delete all transients prefixed <code>eo_</code> .Use this only if you know what you are doing</div>';
...
//	$theList['default'] = OPTIONS_FRAMEWORK_DIRECTORY . 'themes/default-thumbnail.png';
	$theList = array();
	...
	$options[] = array( "name" => __('GA UA code', 'eo_theme'),
						"desc" => 'Simply add your UA-123456-78 code <b>including</b> UA part. For  <a href="https://support.google.com/analytics/answer/1008080?hl=en" target="_blank">more info click here</a>.',
						"id" => "google_ua_key",
						"class" => eo_opt_dept('google_ua_key','|is_ua_code|','col-sm-6 col-md-4 col-lg-3|col-sm-6 col-md-4 col-lg-3'),
						"group" => "Google Analytics",
						"placeholder" => "UA-123456-78",
						"type" => "text",
						"std" => ''
						);
						
	$options[] = array( "name" => __('GA Notice - Beware !', 'eo_theme'),
						"id" => "ga_notice",
						"class" =>'col-sm-6 col-md-8 col-lg-9',
						"group" => "Google Analytics",
						"desc" => '<div class="alert alert-danger"><h4>Beware</h4><b>Google Analytics options will be removed in next release due to</b> the fact that this functionality is not allowed in themes and falls into plugin territory category.<br /> <b>Please use a plugin for google analytics</b></div>',
						"type" => "free_html");
	$options[] = array( "name" => __('Subdomains of ?', 'eo_theme'),
						"desc" => '<div>Turn this option on to modify your tracking code so you can track your subdomains, as well. This option adds the _setDomainName function to   your code. <a href="https://support.google.com/analytics/answer/1033876">Learn more</a> about tracking across multiple domains.</div>',
						"id" => "ga_subd",
						"std" => "0",
						"class" => eo_opt_dept('google_ua_key','linvalidl','col-sm-6 col-md-4 col-lg-3|col-sm-6 col-md-4 col-lg-3 stack'),
						"group" => "Google Analytics",
						"type" => "checkbox");
						
	$options[] = array( "name" => __('Mult.top-level domains of ?', 'eo_theme'),
						"desc" => '<div>Turn this option on to track across multiple top-level domains. This option   adds the _setDomainName and _setAllowLinker functions to your tracking   code. <a href="https://support.google.com/analytics/answer/1033876">Learn more</a> about tracking across multiple domains.</div>',
						"id" => "ga_topl",
						"std" => "0",
						"class" => eo_opt_dept('ga_subd','1','col-sm-6 col-md-4 col-lg-3|col-sm-6 col-md-4 col-lg-3 stack'),
						"group" => "Google Analytics",
						"type" => "checkbox");
						
	$options[] = array( "name" => __('Advertiser Support ?', 'eo_theme'),
						"desc" => 'Learn more about it  <a href="https://support.google.com/analytics/answer/2444872?hl=en&utm_id=ad"> here</a>',
						"id" => "ga_advs",
						"std" => "0",
						"class" => eo_opt_dept('google_ua_key','linvalidl','col-sm-6 col-md-4 col-lg-3|col-sm-6 col-md-4 col-lg-3 stack'),
						"group" => "Google Analytics",
