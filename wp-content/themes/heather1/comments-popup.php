...
<p>Line and paragraph breaks automatic, e-mail address never displayed, <acronym title="Hypertext Markup Language">HTML</acronym> allowed: <code><?php if ( function_exists('allowed_tags') ) { echo allowed_tags(); } ?></code></p>
