...
//style="border:20px solid; border-color:#ff0000 #0000ff;"
        ...
        // JG add_action ( '__header',        array( $this , 'tc_tagline_display' ) , 20, 1 );
        // JG add_action ( '__header',        array( $this , 'tc_navbar_display' ) , 30 );
        add_action ( '__header',            array( $this , 'tc_custom_header_display' ) , 20, 1 );

        //body > header > navbar actions ordered by priority
        // JG add_action ( '__navbar',        array( $this , 'tc_social_in_header' ) , 10, 2 );
        // JG add_action ( '__navbar',        array( $this , 'tc_tagline_display' ) , 20, 1 );
    }
...
?>              
                <div class="brand span3 pull-center">
        ...
        ob_start();
            ...
            <div class="navbar-wrapper clearfix span9">
                ...
                <div class="navbar notresp row-fluid pull-left">
                    ...
                    <div class="navbar-inner" role="navigation"> <?php // JG creates box ?>
                        <?php tc__f( 'tip' , __FUNCTION__ , __CLASS__, __FILE__ ); ?>
                        
                        <div class="row-fluid"> <?php // JG tag line holder ?>
    ...
    /**
     * Displays header in custom format, log|site name, tagline, and social media
     *
     *
     */
...
//********* NEW STUFF             
            ...
            <div class="unit-bg pull-center clearfix span12" style="margin-right: auto;margin-left: auto;width: 1170px;" >
...
//********* NEW STUFF             
        ...
        echo apply_filters( 'tc_custom_header_display', $html );
    }
